                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="mb-3">
                                <div class="form-group label-floating">
                                    ...
                                    <textarea class="form-control" rows="3" name="article"  placeholder="Article" value="{{ $news->article }}"></textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="mb-3">
                                    ...
                                    <input class="form-control" type="file" name="image" onchange="preview()" multiple value="{{ $news->image }}">
                            </div>
